...
public abstract class IOUtil {
    ...
    public static byte[] readDynamicSizeBytes(InputStream is) throws IOException {
        int len = byteArrayToInt(readBytesOrWait(is, 2));
        return readBytesOrWait(is, len);
    }
}
